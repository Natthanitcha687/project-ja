        ...
        <form onSubmit={handleSubmit} className="bg-white border border-slate-100 rounded-lg p-6 shadow-sm">
          <div className="grid gap-4">
            <label className="flex flex-col">
              ...
              <input value={name} onChange={e => setName(e.target.value)} className="mt-1 border rounded px-3 py-2" placeholder="ชื่อของคุณ" />
            </label>
            ...
            <label className="flex flex-col">
              ...
              <textarea value={message} onChange={e => setMessage(e.target.value)} rows={6} className="mt-1 border rounded px-3 py-2" placeholder="บอกรายละเอียดปัญหาหรือคำถามของคุณ"></textarea>
            </label>
