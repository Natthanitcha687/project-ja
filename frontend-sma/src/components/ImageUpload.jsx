        ...
        {images.length < maxImages && (
          <div className="mb-4 flex flex-col items-start">
            ...
            <button
              ...
              disabled={disabled || uploading}
              className="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 hover:border-gray-400 hover:text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {images.map((image, index) => (
              <div key={image.id} className="group relative">
                <div className="aspect-square overflow-hidden rounded-lg bg-gray-100 cursor-pointer">
                  <img
                    src={image.url?.startsWith('blob:') ? image.url : `${import.meta.env.VITE_API_URL || 'http://localhost:4000'}${image.url}`}
