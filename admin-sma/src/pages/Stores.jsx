                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    {sReason === "other" && (
                      <input
                        type="text"
                        value={sReasonOther}
                        onChange={e => setSReasonOther(stripEmojis(e.target.value))}
            ...
            <div className="mt-2 space-y-2">
              ...
              {dReason === "other" && (
                <input
                  type="text"
                  value={dReasonOther}
                  onChange={e => setDReasonOther(stripEmojis(e.target.value))}
                  placeholder="โปรดระบุเหตุผล"
            ...
            <div className="mt-4 rounded-xl border border-rose-100 bg-rose-50/50 p-4 space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-rose-600 font-medium italic">
                  * บัญชีร้านนี้จะถูกเก็บข้อมูลไว้ตามระยะเวลาที่กำหนดด้านบนก่อนถูกทำลายทิ้งถาวร
                </p>
            </div>
